...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec  9 16:25:20 2022
...
ecc_f = pd.DataFrame(ecc_f)

ecc_f.plot(kind='hist', bins=50, edgecolor='black', alpha=1, legend=None)
plt.title('Eccentricity Distribution')
plt.xlabel('Eccentricity')
plt.ylabel('Number')
#plt.xlim(0,2)
plt.savefig(path3 + 'Eccentricity_' + runID + '.png')